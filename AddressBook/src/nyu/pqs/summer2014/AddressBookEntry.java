...
public class AddressBookEntry {
	...
	/**
	 * Concatenates all fields to one single with separated by new line characters.
	...
	public int hashCode() {
		int code = 1;
		String total = this.toFileFormat();
		for(int i = 0; i < total.length(); ++i){
			Character c = total.charAt(i);
			if(c!='\n'){
				code *= 31;
				code += c;
			}
